...
const ArchiveIcon = ({isActive}) => {
  ...
  return (
    ...
    >
      <g opacity='0.15'>
        <path
          d='M14.9298 2.5V8.4C14.9298 8.84 14.4098 9.06 14.0898 8.77L12.3398 7.16C12.1498 6.98 11.8498 6.98 11.6598 7.16L9.90982 8.76C9.58982 9.06 9.06982 8.83 9.06982 8.4V2.5C9.06982 2.22 9.28982 2 9.56982 2H14.4298C14.7098 2 14.9298 2.22 14.9298 2.5Z'
          fill={iconColor}
        />
        <path
